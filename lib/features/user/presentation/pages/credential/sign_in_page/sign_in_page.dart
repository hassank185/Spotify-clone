...
class _SignInPageState extends State<SignInPage> {
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 10,),
                      Text("Log in to Spotify", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
                    ],
                  ),
                ),
                Column(
  ...
  _logInMethod ({String? title, Color? textColor, Color? backgroundColor, IconData? icon, bool? isImage, String? logo, Color? borderColor}) {
    return SizedBox(
      width: double.infinity,
